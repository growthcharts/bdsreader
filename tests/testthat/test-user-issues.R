...
# library(grid)
# g <- process_chart(target = data, chartcode = "NJCH", dnr = "4-18",
#                    period = c(0.25, 4), nmatch = 5)
#
# # "problem plot"
...
# # We may reproduce the error with
...
# # bezoek: (4m-45m werkt),
# # bezoek: (3m-45) geeft Server error (rq2 - draw_chart):
# # In call: select(., all_of(c(".row", !!vars)))
